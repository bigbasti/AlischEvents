     ...
     <div class="pp_overlay"></div>', gallery_markup: '<div class="pp_gallery"> \
        ...
        $.prettyPhoto.open = function (event) {
            ...
            if (settings.social_tools) {
                var imgid = window.location.href.substring(window.location.href.indexOf("/", window.location.href.length - 10) + 1, window.location.href.lastIndexOf("/"));
                facebook_like_link = settings.social_tools.replace('{location_href}', window.location.hostname + pp_images[imgid]);
